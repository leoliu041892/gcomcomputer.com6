...
<?php
	...
	*/
	...
	$targetpage = "internal2.php"; 	//your file name  (the name of this file)
	$limit = 27; 								//how many items to show per page
	$page = $_GET['page'];
	if($page) 
...
<form method="get" action="internalsearch.php?" id="boxpanel" class="form-panel" />
